...
Namespace XtraPivotGrid_FindCells
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.radioGroup1.Properties.Items.AddRange(New DevExpress.XtraEditors.Controls.RadioGroupItem() { New DevExpress.XtraEditors.Controls.RadioGroupItem(Nothing, "Default Layout"), New DevExpress.XtraEditors.Controls.RadioGroupItem(Nothing, "Remove Columns with Zero Summary Values")})
